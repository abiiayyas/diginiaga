        ...
        <nav class="hs-accordion-group p-4 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
            <ul class="flex flex-col space-y-2">
                ...
                <li class="pt-4 mt-4 border-t border-gray-100">
                    <a href="{{ route('admin.warehouses.index') }}" class="flex items-center gap-x-3 py-2.5 px-4 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('admin.warehouses.*') ? 'bg-brand-600 text-white shadow-md shadow-brand-500/20' : 'text-gray-600 hover:bg-surface-100 hover:text-gray-900' }}">
