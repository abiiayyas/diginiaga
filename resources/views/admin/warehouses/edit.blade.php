...
<div class="space-y-6">
    ...
    <form action="{{ route('admin.warehouses.update', $warehouse) }}" method="POST" class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        @csrf
        @method('PUT')
        <div class="p-6 md:p-8 space-y-6">
            ...
            <div class="relative" x-data="areaSearch()">
                <label for="area_search" class="block text-sm font-medium text-gray-700 mb-1">Ubah Area / Kota (Opsional)</label>
            ...
            <div>
                ...
                <textarea name="address" id="address" rows="3" required
                          class="w-full rounded-xl border-gray-200 focus:border-brand-500 focus:ring focus:ring-brand-500 focus:ring-opacity-50">{{ old('address', $warehouse->address) }}</textarea>
